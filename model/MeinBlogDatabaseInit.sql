...
set @sql=concat("CREATE SCHEMA ",@dbname, " DEFAULT CHARACTER SET utf8 COLLATE utf8_bin ;");
PREPARE stmt FROM @sql;
EXECUTE stmt;
DEALLOCATE PREPARE stmt;

set @sql=concat("CREATE TABLE ", @dbname ,".`mb_file_header` (
...
set @sql=concat("CREATE TABLE ", @dbname ,".`mb_file_content` (
...
set @sql=concat("CREATE TABLE ", @dbname ,".`mb_file_tag` (
...
set @sql=concat("CREATE TABLE ", @dbname ,".`mb_category` (
...
set @sql=concat("CREATE TABLE ", @dbname ,".`mb_user` (
...
set @sql=concat("CREATE TABLE ", @dbname ,".`mb_file_comment` (
...
set @sql=concat("CREATE TABLE ", @dbname ,".`mb_register_code` (
...
set @sql=concat("INSERT INTO ", @dbname ,".`mb_user`
(
`user_id`,
`name`,
`password`,
